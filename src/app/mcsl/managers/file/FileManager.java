...
import app.mcsl.utils.EnumUtil;
...
import app.mcsl.windows.elements.dialog.customdialogs.ImportServerDialog;
import app.mcsl.windows.elements.dialog.customdialogs.RepairServerDialog;
...
public class FileManager {
    ...
    public static Image SETTINGS_ICON = new Image("app/mcsl/resources/settings_icon.png");
    public static Image NOTIFICATION_ICON = new Image("app/mcsl/resources/notification_icon.png");
    public static Image MCSL_IMAGE = new Image("app/mcsl/resources/MinecraftServerLauncher.png", 500, 30, false, true);
    public static Image FILE_ICON = new Image("app/mcsl/resources/file_icon.png", 50, 50, false, true);
    public static Image FILE_ICON_20 = new Image("app/mcsl/resources/file_icon.png", 20, 20, false, true);
    public static Image FILE_ICON_100 = new Image("app/mcsl/resources/file_icon.png", 100, 100, false, true);
    public static Image SERVER_ICON = new Image("app/mcsl/resources/server_icon.png");
    public static Image EXTERNAL_SERVER_ICON = new Image("app/mcsl/resources/connect_icon.png", 20, 20, false, true);
    public static Image HOUSE_ICON = new Image("app/mcsl/resources/house_icon.png");
    public static Image CHOOSE_ICON = new Image("app/mcsl/resources/choose_icon_mini.png");
    public static Image RENAME_ICON = new Image("app/mcsl/resources/rename_icon_mini.png");
    public static Image DELETE_ICON = new Image("app/mcsl/resources/delete_icon_mini.png");
    public static Image START_ICON = new Image("app/mcsl/resources/start_icon_mini.png");
    public static Image STOP_ICON = new Image("app/mcsl/resources/stop_icon_mini.png");
    public static Image STEVE_ICON = new Image("app/mcsl/resources/steve_icon.jpg", 18, 18, false, true);
    ...
    public static Image GITHUB_ICON_20 = new Image("app/mcsl/resources/github_icon.png", 20, 20, false, true);
    public static Image WEBSITE_ICON_20 = new Image("app/mcsl/resources/website_icon.png", 20, 20, false, true);
    ...
    public static void checkFiles() throws IOException {
        ...
        if (!configProps.hasProp("language") || !getFileNamesInJarPath("app/mcsl/resources/languages").contains(configProps.getProp("language") + ".properties")) {
